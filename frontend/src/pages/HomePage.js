      ...
      <section className="w-full px-4 sm:px-6 md:px-16 pt-6 sm:pt-10 pb-6 flex flex-col md:flex-row items-stretch gap-4">
        ...
        <div className="flex-1 rounded-2xl bg-[#f5f7fc] p-6 sm:p-8 md:p-12 flex flex-col justify-center items-start gap-3">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
            <button className="bg-black rounded-full text-white px-6 py-3 text-sm font-medium hover:bg-gray-800 transition-colors text-center">
              Get Started — It's Free
            </button>
            <button className="text-sm text-gray-400 hover:text-gray-700 underline underline-offset-2 transition-colors text-center sm:text-left">
              View Assessments →
            </button>
          </div>
